...
export const badges = [
  {
    ...
    description:
      "Recognized by the American Kennel Club for demonstrating a commitment to health screenings, AKC event participation, and responsible breeding practices.",
  },
  {
    id: "akc-platinum",
    ...
    description:
      "Our highest AKC recognition, awarded to breeders who exceed standard requirements with additional health testing, mentorship programs, and championship titles.",
  },
  {
    id: "ofa-chic",
    ...
    description:
      "All breeding dogs complete OFA certifications for hips, elbows, and cardiac health, registered with CHIC for ongoing transparency.",
  },
  {
    id: "bred-with-heart",
    ...
    description:
      "AKC's program honoring our commitment to health testing, education, accountability, responsible practices, and tradition.",
  },
];
...
export default function CertificationsSection({
  ...
  return (
    <section className={cn("bg-white my-16 lg:my-28", className)}>
      <Container>
        <FadeIn>
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-24">
            ...
            <div className="space-y-6">
              ...
              {withCta && <SlideArrowLink href="/about" text="Read More" />}
            </div>
