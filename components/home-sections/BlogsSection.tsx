...
export default function BlogsSection() {
  ...
  return (
    <section className="py-16 bg-gray-50 relative lg:py-28">
        <Image src="/magazine.png" alt="magazine bg" className="opacity-5 absolute w-1/2 right-0 top-0 lg:-top-18" width={1000} height={1000}/>
      <Container>
        <div className="flex flex-col  gap-16">
          <div className="space-y-8 max-w-3xl">
            ...
            <p className="text-paragraph">
              ...
              magni ipsum nisi! Alias at rem, unde eligendi aliquam cupiditate
              pariatur fugiat temporibus soluta fuga eos consequatur nesciunt
              incidunt, nulla tenetur.
            </p>
