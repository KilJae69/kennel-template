...
export default function FlipCard({
  ...
  return (
    <div className={cn("group h-72 w-56 [perspective:1000px]", className)} {...props}>
      ...
      >
        {/* Front */}
        <div className="absolute h-full bg-white w-full [backface-visibility:hidden]">
          <Image
            src={image}
            alt="image"
            width={300}
          ...
          />
          <div className="absolute bottom-4 left-4 text-xl font-bold text-primary-accent">{title}</div>
        </div>
